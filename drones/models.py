...
class Drone(models.Model):
    state_choices = (('idle','IDLE'), ('loading','LOADING'), ('loaded','LOADED'),('delvering','DELIVERING'), ('delivered','DELIVERED'), ('returning','RETURNING'))
    model_choices = (('lightweight','Lightweight'), ('middleweight','Middleweight'),('cruiseweight','Cruiserweight'), ('heavyweight','Heavyweight'))
